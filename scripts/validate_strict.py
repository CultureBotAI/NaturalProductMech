#!/usr/bin/env python3
"""Strict LinkML validation harness for NaturalProductMech instance records.
...
def main() -> int:
    ...
    parser.add_argument("paths", nargs="*", type=Path,
                        help="Files or directories. Defaults to data/natural_products/.")
    ...
    if not files:
        # An empty corpus is not a validation failure, but a mistyped path is.
        # Distinguish them, or `just qc` stays red through M1 for a reason that
        # has nothing to do with record validity — and a red gate nobody can
        # fix is a gate people learn to ignore.
